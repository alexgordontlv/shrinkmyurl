							...
							<div className='flex-1 flex items-center justify-center md:justify-between sm:items-stretch '>
								<Link to='/'>
									<div className='flex items-center justify-start mr-10 md:mr-0'>
										<p className='text-xl font-light sm:text-2xl'>SHRINKMY</p>
										<p className='text-xl text-white sm:text-2xl font-light'>.SITE</p>
									</div>
								</Link>
									...
									{currentUser ? (
										...
										<div className='flex justify-end items-center'>
											<Link to='/login'>
												<button
													type='submit'
													className={`mr-0  text-black px-1 py-2 sm:px-3 sm:py-3 sm:mr-3 rounded w-full  hover:underline focus:outline-none`}>
													Login
												</button>
											</Link>
											<Link to='/register'>
												<button
													type='submit'
													className={` bg-black text-white px-1 py-2 sm:px-3 sm:py-3 rounded w-full  hover:bg-gray-800 focus:outline-none`}>
													Register
												</button>
											</Link>
										</div>
